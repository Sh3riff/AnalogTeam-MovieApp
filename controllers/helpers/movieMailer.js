...
module.exports.movieMailer = async () => {
     try {
        ...
        overview = overview || "This Movie does not have a description"
        ...
        const newMovie = new Movie({ "Movie Name": title, "IMDB Score": score, "The movie image": img, "Movie description": overview})
