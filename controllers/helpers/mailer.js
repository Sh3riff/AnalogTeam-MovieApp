...
const confirmationMailer = (email, name, pin) =>{
    const request = mailjet
        ...
        .request({
            "Messages":[{
                "From": {
                    "Email": "contactme@sh3riff.me",
                    "Name": "Movie Recommedation"
                },
                "To": [{
                    "Email": email,
                    "Name": name
    ...
    const request = mailjet
        ...
        .request({
            "Messages":[{
                ...
                "Subject": `Movie of the Day: ${title}`,
                "TextPart": `Movie title:${title}, Description:${overview}, image:${img} & rating:${score} IMDB`,
                "HTMLPart": `<html>
                    <body>
                        <td class="esd-structure es-p20t es-p10b es-p20r es-p20l" align="left">
                            <table cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="esd-block-text es-p10" bgcolor="#DC143C">
                                                            <h2 style="color: #ffffff;">${score} IMDB</h2>
                                                        </td>
                                                    </tr>
                                                    <tr>
